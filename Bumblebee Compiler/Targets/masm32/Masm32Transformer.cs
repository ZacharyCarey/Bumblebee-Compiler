...
{
    internal class Masm32Transformer
    {
        ...
        private static void walkNode(ASTNode node, ASTNode parent, Masm32Transformer program)
        {
        ...
        private static void walkNodes(List<ASTNode> nodes, ASTNode parent, Masm32Transformer program)
        {
        ...
        private static Dictionary<string, Action<ASTNode, ASTNode, Masm32Transformer>> transformMethods = new() {
            {"NumberLiteral", NumberLiteral },
            {"CallExpression", CallExpression },
            {"Operation", Operation }
        };

        private static void NumberLiteral(ASTNode node, ASTNode parent, Masm32Transformer program)
        {
            //            parent.Body.Add(new("NumberLiteral", node.Value));
        }

        private static void CallExpression(ASTNode node, ASTNode parent, Masm32Transformer program)
        {
        ...
        private static void Operation(ASTNode node, ASTNode parent, Masm32Transformer program)
        {
